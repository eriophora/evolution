...
class World():
    ...
    def iterate(self,regen_children = True):
        ...
        childrenEnd = clock()
        self.times['gaming'].append(gamingEnd - gamingStart)
        self.times['stats'].append(statsEnd - statsStart)
        self.times['children'].append(childrenEnd - childrenStart)
        self.times['moving'].append(movingEnd - movingStart)
